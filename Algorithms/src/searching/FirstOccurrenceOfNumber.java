...
// Program to find the first occurrence of a number using Binary Search Algorithm
public class FirstOccurrenceOfNumber {

	// method to find the first occurrence of a number
	...
	public static void main(String[] args) {
		try {
			System.out.println("******* Binary Search Algorithm - First Occurrence Of an Element *********");
			...
			System.out.print("\nEnter the element whose first occurrence do you want to find : ");
			...
			if (result == -1) 
				...
				System.out.println("\nThe first occurrence of " + data + " is at position " + (result + 1));
		}
		catch (Exception ex) {
